		...
		<div className="space-y-8">
			...
			<section className="animate-fade-in">
				<div className="flex items-center justify-between mb-6">
					<div>
						<h2 className="text-2xl font-bold text-gray-900 dark:text-white">Available Books</h2>
						<p className="text-gray-600 dark:text-gray-300 mt-1">Books ready for rental</p>
					</div>
					<div className="flex items-center space-x-2">
						<div className="w-3 h-3 bg-green-500 rounded-full"></div>
						<span className="text-sm text-gray-600 dark:text-gray-300">{availableBooks.length} available</span>
					</div>
				</div>
						...
						{availableBooks.map(book => (
							<div key={book.id} className="card p-6 group hover:scale-105 transition-transform duration-300">
								<div className="flex items-start justify-between mb-4">
									<div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center dark:from-blue-600/20 dark:to-blue-700/20">
								...
								<p className="text-gray-600 dark:text-gray-300 text-sm mb-1">by {book.author}</p>
								<p className="text-gray-500 dark:text-gray-400 text-xs mb-4">{book.genre}</p>
								
								<div className="flex items-center justify-between">
									<span className="text-xs text-gray-400 dark:text-gray-500">ID: {book.id}</span>
									<button 
						...
						{availableBooks.length === 0 && (
							<div className="col-span-full">
								<div className="text-center py-12">
									...
									<h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No available books</h3>
									<p className="text-gray-600 dark:text-gray-300">Add some books to get started!</p>
								</div>
							</div>
						)}
					</div>
			...
			<section className="animate-fade-in">
				<div className="flex items-center justify-between mb-6">
					<div>
						...
						<p className="text-gray-600 dark:text-gray-300 mt-1">All books in your library</p>
					</div>
					<div className="flex items-center space-x-2">
						<div className="w-3 h-3 bg-blue-500 rounded-full"></div>
						<span className="text-sm text-gray-600 dark:text-gray-300">{books.length} total</span>
					</div>
				</div>
						...
						{books.map(book => (
							<div key={book.id} className="card p-6">
								{editingBookId === book.id ? (
									...
									<>
										<div className="flex items-start justify-between mb-4">
											<div className="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center dark:from-gray-600/20 dark:to-gray-700/20">
						...
						{books.length === 0 && (
							<div className="col-span-full">
								<div className="text-center py-12">
									...
									<p className="text-gray-600 dark:text-gray-300">Add your first book to get started!</p>
								</div>
							</div>
						)}
					</div>
			...
			<section className="animate-fade-in">
				<div className="card p-8">
					<div className="flex items-center mb-6">
						<div className="w-10 h-10 bg-gradient-to-br from-green-100 to-green-200 rounded-lg flex items-center justify-center mr-4 dark:from-green-600/20 dark:to-green-700/20">
						...
						<div>
							...
							<p className="text-gray-600 dark:text-gray-300">Add a new book to your library</p>
						</div>
					</div>
